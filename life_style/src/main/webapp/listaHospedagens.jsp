...
<div class="container">
    <div class="row">
       <div class="cold-md-7">
          <form action="CreateEndFindHospedagem" class="d-flex" method="GET">
	        <input name="pesquisa" class="form-control me-2" type="search" placeholder="Digite o Nome do Hotel ou o Estado" aria-label="Search">
	        <button class="btn btn-outline-primary" type="submit">Buscar</button>
	      </form>
          <hr>
          <h3> Cadastrado Hospedagem</h3>
          <hr>
          <table class="table">
             <thead>
                <tr>
                	...
                	<th>Data ida</th>
                	<th>Data volta</th>
                	<th>Telefone do hotel</th>
                </tr>
             </thead>
             <tbody>
           		 <c:forEach items="${hospedagens}" var="hospedage">
					<tr>
					    <td>${hospedage.id}</td>
					    <td>${hospedage.nomeHotel}</td>
					    <td>${hospedage.endereco}</td>
					    <td>${hospedage.estado}</td>
					    <td>${hospedage.valor}</td>
					    <td>${hospedage.checkIn}</td>
					    <td>${hospedage.checkOut}</td>
					    <td>${hospedage.telefoneHotel}</td>
					    <td>
							<a href="HospedagemDestroy?hospedagemId=${hospedage.id}">deletar</a>
							<a href="HospedagemUpdate?hospedagemId=${hospedage.id}">atualizar</a>
			            </td>
				   </tr>
                 </c:forEach>
             </tbody>
