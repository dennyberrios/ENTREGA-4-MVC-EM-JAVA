         ...
         <div class="cold-md-7">
             ...
             <form action="DestinoUpdate" method="POST">
                   ...
                   <div class="form-floating mg-3">
                       <input value="${destino.nome}" name="nome" maxlength="80" type="text" class="form-control" id="floatingInput1" >
                       <label>Nome Completo</label>
                   </div>
                   <br>
                   <div class="form-floating mg-3">
                       <input value="${destino.cidade}" name="cidade" maxlength="20" type="text" class="form-control" >
                       <label>Cidade</label>
                   </div>
                   <br>
                   <div class="form-floating mg-3">
                       <input value="${Destino.estado}" name="estado" maxlength="50" type="text" class="form-control" id="floatingInput1" >
                       <label>Estado</label>
                   </div>
                   <br>
                   <div class="form-floating mg-3">
                       <input value="${destino.dataIda}" name="dataIda" maxlength="50" type="date" class="form-control" id="floatingInput1" >
                       <label>Data de ida</label>
                   </div>
                   <br>
                   <div class="form-floating mg-3">
                       <input value="${destino.dataVolta}" name="dataVolta" maxlength="50" type="date" class="form-control" >
                       <label>Data de volta </label>
                   </div>
                   <br>
                   <div class="form-floating mg-3">
                       <input value="${destino.valor}" name="valor" maxlength="50" type="text" class="form-control" id="floatingInput1">
                       <label>Valor</label>
                   </div>
                   <br>
